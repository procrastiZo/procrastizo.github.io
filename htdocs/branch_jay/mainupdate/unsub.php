...
$filename = __DIR__ . '/content/user.json'; //this is the rows.json file 
...
$name = $data['Name']; //this finds the id value of the row 
$email= $data['Email']; 
$str= "\"Email\":\"$email\"" ; //this will be the string that we will have to find in the rows.json file that will find the row we want to delete
